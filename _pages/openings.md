...
<p>The Yu Lab develops and applies computational and statistical methods to multi-omics data (germline and somatic DNA, methylation, RNA, and protein) and other multi-modal data (medical imaging, EHR) to examine mechanisms and potential interventions for cardiovascular and other age-related diseases. We are particularly interested in age-related somatic mutations, in blood (clonal hematopoiesis) and in other tissues.</p>
...
<ul>
  <li><strong>Somatic Mutations (Clonal Hematopoiesis) &amp; Age-related Disease:</strong> How age-related somatic mutations, particularly clonal hematopoiesis, contribute to disease. The candidate will likely be involved in somatic mutation calling from whole genome/exome sequencing data.</li>
...
<ul>
  <li>Master's degree in a quantitative field such as Biostatistics, Bioinformatics, Computational Biology, Electrical or Biomedical Engineering, or Genetic Epidemiology.</li>
  <li>Strong programming skills (e.g., R or Python).</li>
  <li>Experience analyzing large-scale, complex datasets preferred.</li>
...
<p><strong>How to Apply:</strong> Send your CV, a short introduction, and details of your research experience to both Aeron Small (<a href="mailto:asmall@bwh.harvard.edu">asmall@bwh.harvard.edu</a>) and Zhi Yu (<a href="mailto:zyu5@mgh.harvard.edu">zyu5@mgh.harvard.edu</a>).</p>
