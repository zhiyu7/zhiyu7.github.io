...
<div class="jumbotron">
  <h3>Bio</h3>
  <p>I am an Investigator at <a href="https://www.massgeneral.org/" target="_blank">Massachusetts General Hospital (MGH)</a> and an Assistant Professor of Medicine at <a href="https://hms.harvard.edu/" target="_blank">Harvard Medical School</a>. I am also an Associate Member at <a href="https://www.broadinstitute.org/" target="_blank">Broad Institute of MIT and Harvard</a> and <a href="https://cgm.massgeneral.org/" target="_blank">Center for Genomic Medicine</a> at MGH (<a href="https://researchers.mgh.harvard.edu/profile/14495114/Zhi-Yu" target="_blank">link to faculty page</a>).</p>
...
<div class="jumbotron">
  <h3>Service</h3>
  <p>I co-founded the <a href="/smart-jc/">Somatic MutAtion Research Trainee (SMART) Journal Club</a> in April 2023 and have co-organized it ever since. I have served on the Program Committee of the <a href="https://www.ashg.org/">American Society of Human Genetics</a> since January 1, 2026, and will serve on the American Heart Association’s Genomic and Precision Medicine (GPM) Committee beginning October 1, 2026.</p>
</div>


<div class="jumbotron">
  <h4>Thanks</h4>
  <div markdown="0" style="display:flex; align-items:center; justify-content:center; flex-wrap:nowrap; gap:clamp(12px, 4vw, 40px); margin:0 auto;">
  {% for funder in site.data.funders %}<a href="{{ funder.url }}" target="_blank" style="display:flex; align-items:center; justify-content:center; flex:1 1 0; min-width:0; max-width:220px;"><img src="{{ site.url }}{{ site.baseurl }}/images/{{ funder.image }}" style="display:block; width:auto; height:auto; max-height:80px; max-width:100%; margin:0;"/></a>{% endfor %}
  </div>
</div>
